<template>
    <div class="container">
        ...
        <div class="dishes">
            <h1>Popular 🔥</h1>
            <EDishes></EDishes>
            <div class="dishes__chicken">
                <h1>Chicken Vegetables</h1>
                <div class="dishes__cards dishes__cards--food">
